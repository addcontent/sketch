...
// parseCLIFlags parses all command-line flags, including user-visible and internal/debugging options, and returns a populated CLIFlags struct reflecting the user's configuration and environment.
